"""
Django settings for Fit4You project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'pd-=mnp-_rq84u@1=o)\
                             8$gq79kve(-gwo-wqf@_5pz@kiafg7d')
...
WSGI_APPLICATION = 'Fit4You.wsgi.application'
...
#  Static_root added to allow Heroku serve static files
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'fit4you@programs.com'
else:
