...
class LoginRequiredNewTopicTests(TestCase):
    ...
    def test_redirection(self):
        # test user is redirected tp the sites login page
...
class NewTopicTests(TestCase):
    def setUp(self):
        # Create a test board with test user
        Board.objects.create(name='Test', description='test board')
    ...
    def test_new_topic_view_success_status_code(self):
        ...
        url = reverse('test_topic', kwargs={'pk': 1})
    ...
    def test_new_topic_url_resolves_new_topic_view(self):
        ...
        self.assertEquals(view.func, new_topic(request, pk))